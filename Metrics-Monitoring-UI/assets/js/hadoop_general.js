...
md = {
    ...
    initHadoopPageCharts: function () {
        var mdata = localStorage.getItem("otp1");
        localStorage.clear();
        ...
        function myvar() {
		  ...
		  var uri1 = "http://hadoop1.example.com:8088/ws/v1/cluster/apps"+value2;
            ...
            function myFunction10(arr1) {
                var amb = arr1.allocatedMB;
                //var mem = arr1.memoryUsed;
                var avc = arr1.allocatedVCores;
                var rc = arr1.runningContainers;
                var ms = arr1.memorySeconds;
                var vs = arr1.vcoreSeconds;
                var cup = arr1.clusterUsagePercentage;
                var prm = arr1.preemptedResourceMB;
                var prv = arr1.preemptedResourceVCores;
                var out = "";
                var i = arr1.name;
                var j = arr1.state;
                var k = arr1.finalStatus;
                var l = arr1.progress;
                var x = arr1.applicationType;
                var y = arr1.priority;
                ...
                document.getElementById("zz").innerHTML = y;
                document.getElementById("onn").innerHTML = l;
            ...
            if ($('#dailySalesChart9').length != 0) {
                ...
                var completedTasksChart = new Chartist.Line('#dailySalesChart9', dataCompletedTasksChart, optionsCompletedTasksChart);
